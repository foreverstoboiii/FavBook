        ...
        li.innerHTML = `
          <div class="flex justify-between items-center w-full gap-4 px-2 py-[10px] rounded text-sm">
            <div class="flex flex-col" title="${book.name} - ${book.author}">
              <span class=" font-medium text-[15px] text-white truncate max-w-[180px] block">${book.name}</span>
              <span class="text-xs text-gray-400 truncate max-w-[180px] block">${book.author}</span>
            </div>
